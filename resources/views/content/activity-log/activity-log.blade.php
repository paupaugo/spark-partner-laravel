        ...
        <div class="card-body">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="ongoing" aria-labelledby="ongoing-tab" role="tabpanel">
              ...
              <div class="tab-pane" id="done" aria-labelledby="done-tab" role="tabpanel">
                <table class="datatables-basic-done table">
                  <thead>
                    <tr>
                      <th>Parking Address</th>
                      <th>Hours</th>
...
@section('page-script')
  ...
  <script src="{{ asset(mix('js/scripts/activity-log/activity-log-crud.js')) }}"></script>
